package Modulo02.Aula20_1.view;

import java.util.ArrayList;
import java.util.Scanner;

import Modulo02.Aula20_1.controller.ArtistaController;
...
public class ArtistaView {
    ...
    private static void listar(ArtistaController controller) {
        ...
        for (Artista artista : lista) {
            System.out.printf("\nNome: %s, Categoria: %s, Nacionalidade %s", artista.nome, artista.categoria, artista.nacionalidade);
        }
    }
